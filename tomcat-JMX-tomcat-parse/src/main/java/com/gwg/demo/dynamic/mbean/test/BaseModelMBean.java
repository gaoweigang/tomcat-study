...
package com.gwg.demo.dynamic.mbean.test;
...
public class BaseModelMBean implements DynamicMBean, MBeanRegistration,
        ...
        throws MBeanException, ReflectionException
    {
        ...
        try {
            ...
            Throwable t = e.getTargetException();
            System.out.println("Exception invoking method " + name + "  : " + t.getMessage() );
            if (t == null)
                t = e;
            if (t instanceof RuntimeException)
                throw new RuntimeOperationsException
            ...
            System.out.println("Exception invoking method " + name + "  : " + e.getMessage() );
            throw new MBeanException
                (e, "Exception invoking method " + name);
        }
        ...
        ReflectionException
    {
        ...
        try {
            ...
            System.out.println("Error sending notification " + name +" : "+ ex.getMessage());
        }
...
//        }
    ...
    public void sendAttributeChangeNotification
        ...
        System.out.println( "AttributeChangeNotification " + notification );
    ...
    public void addNotificationListener(NotificationListener listener,
        ...
        System.out.println("addNotificationListener " + listener);
        ...
        System.out.println("addAttributeNotificationListener " + listener);
...
//                            "displayName=jmx.attribute.change" });
    ...
    public ObjectName preRegister(MBeanServer server,
            ...
            throws Exception
    {
        System.out.println("preRegister " + resource + " " + name );
        oname=name;
